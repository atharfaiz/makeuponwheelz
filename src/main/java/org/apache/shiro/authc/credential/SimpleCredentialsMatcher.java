...
public class SimpleCredentialsMatcher extends CodecSupport implements CredentialsMatcher {
    ...
    protected boolean equals(Object tokenCredentials, Object accountCredentials) {
        ...
        if (isByteSource(tokenCredentials) && isByteSource(accountCredentials)) {
           ...
           // log.info("hashed credential "+Arrays.equals(tokenBytes, accountBytes));
            return Arrays.equals(tokenBytes, accountBytes);
        } else {
        	//log.info("hashed credentials"+String.valueOf(accountCredentials.equals(tokenCredentials)));
    ...
    public boolean doCredentialsMatch(AuthenticationToken token, AuthenticationInfo info) {
        ...
        //log.info("doCredentialsMatch of simple credentials"+equals(tokenCredentials, accountCredentials)+", token credential class name: "+tokenCredentials.getClass().getSimpleName());
        return equals(tokenCredentials, accountCredentials);
    }
    
    public SimpleCredentialsMatcher(){
    	//log.info("SimpleCredentialsMatcher class constructor called");
    }
