...
<HTML lang="<%= attributeBean.getLanguage() %>">
	<HEAD>
		...
		<link rel="shortcut icon" href="/sgterp/resources/img/sgterp.ico" />
		<%
...
<script src="birt/JSCal2-1.9/js/jscal2.js" type="text/javascript"></script>
<script src="birt/JSCal2-1.9/js/lang/en.js" type="text/javascript"></script>
<link rel="stylesheet" href="birt/JSCal2-1.9/css/border-radius.css" meda="screen" type="text/css"/>
<link rel="stylesheet" href="birt/JSCal2-1.9/css/jscal2.css" meda="screen" type="text/css"/>
<link rel="stylesheet" href="birt/JSCal2-1.9/css/gold/gold.css" meda="screen" type="text/css"/>
	...
	<BODY 
		...
		<TABLE ID='layout' CELLSPACING='0' CELLPADDING='0' STYLE='width:100%;height:100%'>
			<%
				...
				{
			%>
			<TR CLASS='body_caption_top'><!-- attributeBean.isShowTitle( )  write this to show title of Report    -->
				<TD COLSPAN='2'></TD>
			</TR>
