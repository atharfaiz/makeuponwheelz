						...
						<div class="col-sm-12" style="margin-top:15%;">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									<p style="margin-left:20px;">Congratulations !! ${firstName } ${"  "} ${lastName} </p> 
								</div>
								...
								<p style="margin-left:20px;">Your registration is successfull in SGT University. </p> 
								<p style="margin-left:20px;">Registration No is : ${generatedRegNo}.</p> 						
