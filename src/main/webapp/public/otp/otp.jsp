...
<head>
  ...
  <link rel="shortcut icon" href="/assets/img/favicon.ico">
	...
	<script src="/assets/js/ng-controller/compRegCtrl.js"></script>
	<!-- <script src="/assets/js/ngApp/otp.js"></script> -->
	<script src="/assets/js/ng-controller/otpCtrl.js"></script>
...
<body class="external-page sb-l-c sb-r-c">
  ...
  <div id="main" class="animated fadeIn">
    ...
    <section id="content_wrapper">
      ...
      <!-- Begin: Content -->
      <section id="content"   ng-cloak ng-controller="otpCtrl">
